...
void Spinner::begin() {
    ...
    lv_obj_set_style_bg_color(container, lv_color_hex(0x202C33), 0);
    ...
    lv_obj_set_style_arc_color(spinner, lv_color_hex(0x374045), LV_PART_MAIN);
    lv_obj_set_style_arc_width(spinner, 6, LV_PART_MAIN);
    lv_obj_set_style_arc_color(spinner, lv_color_hex(0x53BDEB), LV_PART_INDICATOR);
    ...
    lv_obj_set_style_text_color(message_label, lv_color_hex(0xE9EDEF), 0);
