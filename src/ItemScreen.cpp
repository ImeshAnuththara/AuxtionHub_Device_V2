...
//             lv_obj_set_style_bg_color(item_main_card, COLOR_WHITE, 0);
//             lv_timer_del(t);
//         }, 100, nullptr);
...
//     lv_obj_set_style_text_color(item_loading_label, COLOR_DARK, 0);
...
//     lv_obj_set_style_text_color(item_auction_id_label, COLOR_DARK, 0);
...
//     lv_obj_set_style_text_color(item_details_label, COLOR_DANGER, 0);
...
//     lv_obj_set_style_text_color(item_place_bid_label, COLOR_WHITE, 0);
...
// void load_items_from_mqtt(const JsonArray& items_array, const char* auction_mode) {
//     if (!items_array) {
...
//     const char* auction_id = get_auction_id();
...
//     lv_obj_set_style_bg_color(bid_popup, COLOR_WHITE, 0);
...
//     lv_obj_set_style_text_color(bid_min_label, COLOR_DARK, 0);
...
void init_item_screen(lv_obj_t* parent) {
    ...
    lv_obj_set_pos(item_card1, 20, 45);
    lv_obj_set_size(item_card1, 95, 45);
    lv_obj_set_style_bg_color(item_card1, COLOR_WHITE, 0);
    lv_obj_set_style_border_color(item_card1, COLOR_BORDER, 0);
    lv_obj_set_style_border_color(item_card1, COLOR_BORDER, 0);
    lv_obj_set_style_border_width(item_card1, 2, 0);
    lv_obj_set_style_radius(item_card1, 8, 0);
    ...
    lv_obj_set_pos(item_card2, 125, 45);
    lv_obj_set_size(item_card2, 95, 45);
    lv_obj_set_style_bg_color(item_card2, COLOR_WHITE, 0);
    lv_obj_set_style_border_color(item_card2, COLOR_BORDER, 0);
    lv_obj_set_style_border_color(item_card2, COLOR_BORDER, 0);
    lv_obj_set_style_border_width(item_card2, 2, 0);
    lv_obj_set_style_radius(item_card2, 8, 0);
    ...
    lv_obj_set_style_text_color(item_user_fixed_label, COLOR_DARK, 0);
...
static void show_bid_popup() {
    ...
    lv_obj_set_style_text_color(bid_item_label, COLOR_DARK, 0);
